/***********************************************************
Program: Actor.cpp (Week 8 Course Project)

This program is the class for the Actor object. It contains the actor name
and the character name, with appropriate getters and setters.
...
Actor::Actor(string a, string c)
{
	actorName = a;
	characterName = c;
}

void Actor::setActorName(string name)
{
	actorName = name;
}

void Actor::setCharacterName(string name)
{
	characterName = name;
}
