/*************************************
Program: CarpetCalculator.cpp (Week 1 Programming Assignment 2)

Author: James Olney
Created: 03/04/2017
Revisions: N/A

This is the main class. It will create an instance of RoomCarpet and ask the user for 
...
int main() {
	...
	cout << "length inches: ";
	cin >> dimensionInches;
	FeetInches length(dimensionFeet, dimensionInches);
	cout << "width Feet: ";
	cin >> dimensionFeet;
	cout << "width inches: ";
	cin >> dimensionInches;
	FeetInches width(dimensionFeet, dimensionInches);
	RoomDimension myRoomDimension(length, width);
	cout << "price per square foot: $";
	cin >> price;
	RoomCarpet myRoomCarpet(myRoomDimension, price);
	cout << "totalCostOfTheCarpet is $" << myRoomCarpet.totalCostOfTheCarpet();
