/*************************************
Program: RoomCarpet.cpp (Week 1 Programming Assignment 2)

Author: James Olney
Created: 03/04/2017
Revisions: N/A

This is the class called RoomCarpet class that has a RoomDimension object as an
...
RoomCarpet::RoomCarpet()
{
	...
	costOfCarpetPerSquareFoot = 0.0;
}

RoomCarpet::RoomCarpet(RoomDimension rD, double cost)
{
	roomDimension = rD;
	costOfCarpetPerSquareFoot = cost;
}

double RoomCarpet::totalCostOfTheCarpet()
{
	double total;
	double area = roomDimension.calculateArea();
	total = area * costOfCarpetPerSquareFoot;
	return total;
}

RoomDimension RoomCarpet::getRoomDimension()
{
	return roomDimension;
}

void RoomCarpet::setCostOfCarpetPerSquareFoot(double cost)
{ 
	costOfCarpetPerSquareFoot = cost;
}
