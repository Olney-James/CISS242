/*************************************
Program: RoomCarpet.h (Week 1 Programming Assignment 2)

Author: James Olney
Created: 03/04/2017
Revisions: N/A

This is the header for RoomCarpet.cpp
...
public:
	RoomCarpet();
	RoomCarpet(RoomDimension rD, double cost);
	double totalCostOfTheCarpet();
	RoomDimension getRoomDimension();
	void setCostOfCarpetPerSquareFoot(double cost);
private:
	RoomDimension roomDimension;
	double costOfCarpetPerSquareFoot;
};
