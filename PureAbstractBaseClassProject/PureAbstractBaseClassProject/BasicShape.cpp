/*************************************
Program: BasicShape.cpp (Week 2 Programming Assignment 2)

Author: James Olney
Created: 03/06/2017
Revisions: N/A

This is the BasicShape class which will be a pure abstract 
class. The class will have one protected data member that 
will be a double called area. It will provide a function 
called getArea which should return the value of the data 
member area. It will also provide a function called calcArea
which must be a pure virtual function.
