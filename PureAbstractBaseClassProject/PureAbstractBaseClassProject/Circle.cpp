/*************************************
Program: Circle.cpp (Week 2 Programming Assignment 2)

Author: James Olney
Created: 03/06/2017
Revisions: N/A

This is the Circle class. It is a derived class of the
BasicShape class. This class has 3 private data members. It
has 2 long integer data members called centerX and centerY.
The last data member is a double called radius. It has a
constructor that accepts values for centerX, centerY and radius.
This constructor calls the overridden calcArea function of
...
3.14159 * radius * radius. The class provides two functions
