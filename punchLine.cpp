...
Author: James Olney
Created: 01/16/2017
Revisions: 02/04/2017 //I changed displayLastLine to only read the last line, instead of reading 
each line until the end of the file. This is much more efficient :)
*******************/
...
int main()
{
	...
	int exit;
	dataInFile.open(jokeFileName, ios::in);				
	dataInFileTwo.open(punchLineFileName, ios::in | ios::eof);
	displayAllLines(dataInFile);						//display joke
