/*************************************
Program: CustomerData.h (Week 2 Programming Assignment 1)

Author: James Olney
Created: 03/06/2017
Revisions: N/A

This is the header class for CustomerData.cpp.
...
public:
	CustomerData();
	CustomerData(string l, string f, string a, string c, string s, string z, string p, int cN, bool m);
